      ...
      <div className='footer-top'>
        <div className='footer-content text-white d-grid container'>
          <div className='footer-item'>
            <a href="#" className='brand text-white text-uppercase no-wrap d-block'>
              FREEGAME <span>ADS</span>
            </a>
            <p className='brand-text'> FREEGAMEADS GIVES YOU TONS OF GAME VARIETY TO PLAY AND EXPLORE</p>
          </div>
          ...
          <div className='footer-item'>
            ...
            <p className='para-text'>Subscribe to Freegameads Newsletter .</p>

            <form className='newsletter-form'>
              <div className='input-group d-flex align-items-stretch'>
                <input type="text" className="input-group-field" placeholder = "Enter you email address" />
